...
class Vienmandate2008Spider(CrawlSpider):
        name = "vienmandate2008_2"
        allowed_domains = ["www.vrk.lt"]
	start_urls = ["http://www.vrk.lt/2008_seimo_rinkimai/output_lt/rezultatai_vienmand_apygardose2/rezultatai_vienmand_apygardose2turas.html"]
